...
#define LED2_MASK 0x00020000 //00 02 00 00
#define LED3_MASK 0x00030000 //00 04 00 00
#define LED4_MASK 0x00040000 //00 08 00 00
...
int main()
{
    ...
    while (1)
    {
        ...
        if (inputportstate & SWITCH2_MASK)
        {
            //TODO !!
            // do the interrupt stuff here
            // blink leds using timer
        }
    }
